...
- lab 1_hw: difference between R and R studio  
...
lab 2_hw: Define vectors and data matrices  
...
- lab 3_hw: mammals sleep data into  
...
- lab 4_hw: homerange data, levels, table  
...
- lab 6_hw: same as 6_2  

**Week 7**  
- intro: lab 6 review  
- lab 7_1: Use a combination of `select()`, `filter()`, and `mutate()` to transform data                  frames, Use the `skimr` package to produce summaries of data, Produce clean                    summaries of data using `summarize()`, Use `group_by()` in combination with                    `summarize()` to produce grouped summaries of data. Also learn `n_distinct()`.    
...
- lab 7_hw: When to use `group_by()` vs `count()`. Lots of practice
