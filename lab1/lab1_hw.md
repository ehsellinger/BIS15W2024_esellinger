...
R is the base program which R-Studio requires to run. R-Studio is much more user friendly and has organizational components that make it easier to use and is called a GUI (graphical user interface). GitHub is a data platform which you can use to upload information and save on the internet. You can share this information with others to make your data accessible.
