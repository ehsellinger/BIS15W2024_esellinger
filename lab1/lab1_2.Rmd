...
## Replicate Above with New Numbers 
## to make code chunk can use green c icon at top of script and select R or use "option" "command" "i"
## arrow shortcut: "option" "-"
## To remove variable in environment: rm()
