...
tidyverse = large library, dplyr = data transforming package within tidyverse, select and filter are commands within dplyr
dplyr: A package for data manipulation that uses a consistent and intuitive syntax that makes data manipulation tasks more straightforward. tidyverse: A package for data tidying that helps you transform data between different formats, such as converting wide data to long format or vice versa.
