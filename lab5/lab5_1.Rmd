...
Rules:  
+ `filter(condition1, condition2)` will return rows where both conditions are met. By default the "," = "&"
...
```{r}
mammals2 <- select(mammals, "order", "genus", "species", "mass", "gestation", "newborn")
