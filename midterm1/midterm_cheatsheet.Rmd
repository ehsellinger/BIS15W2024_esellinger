...
- lab 9_2: Explain the difference between tidy and messy data. Evaluate a data set as tidy or messy. Use the `pivot_longer()` function of `tidyr` to transform data from wide to long format. Use `separate()` to split observations within a column.  
